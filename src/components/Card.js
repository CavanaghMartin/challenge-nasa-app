  ...
  return (
    <Card data-testid={`card`} className={classes.root}>
      <CardActionArea>
        ...
        />
        <CardContent>
          <Typography className={classes.cardDescription}> Earth date: {earth_date} </Typography>
          <Typography className={classes.cardDescription}> Solar number:{sol} </Typography>
          <Typography className={classes.cardDescription}> Camera:{cameraName} </Typography>
          <Typography className={classes.cardDescription}> Rover:{roverName}</Typography>
        </CardContent>
      </CardActionArea>
      <CardActions>
